...
- **Pipeline architecture**: The BER program should adopt the full-stack DL philosophy, building
...
- **Self-supervised priority**: Given the difficulty of collecting paired data at
  ...
  learned reconstruction without clean references) should be prioritized over
  supervised approaches.
- **Benchmark contribution**: The BER program should contribute APS-U datasets to
...
- **Priority**: **High** -- provides the conceptual framework for the BER program's
...
the BER program's tomography pipeline.
...
careful loss weighting. The BER program should build modular stages first and pursue joint
